...
const Pariksha = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Pariksha – Gamified Assessment & Career Guidance | EduTechEx</title>
        <meta
          name="description"
          content="Experience gamified assessments with EduTechEx Pariksha. Discover your strengths, get career guidance, and navigate your academic journey."
        />
        <link rel="canonical" href="https://www.edutechex.com/pariksha" />
      </Helmet>
